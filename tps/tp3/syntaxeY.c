...
{
      12,     0,    -1,     8,    13,     9,    -1,    13,    14,    -1,
      14,    -1,     3,     5,    16,     6,    -1,     7,    15,     6,
      -1,    15,    10,     3,    -1,     3,    -1,     4,    -1,     3,
      -1
};
...
{
  "$end", "error", "$undefined", "IDENTIF", "ENTIER", "AFFECT", "PTVIRG",
  "VAR", "'{'", "'}'", "','", "$accept", "program", "listInstr", "inst",
  "listVariables", "expr", 0
};
#endif
...
{
       0,    -2,     9,     5,    10,    -3,    -4,    -4,    -1,    -4,
       1,    -4,    -4,    -4,    -4,     6,    -4,    11,    -4,    -4
};
...
{
       0,     8,    12,     3,     7,    13,    14,     0,     5,     3,
      15,     9,    14,     3,     4,    16,     6,    10,     6,     3
};
...
/* Line 1455 of yacc.c  */
#line 40 "syntaxe.y"
    {if(isDeclared((yyvsp[(1) - (4)].var),vars) == 0) {yyerror("Variable is not declared"); exit(-1);};}
    break;
...
/* Line 1455 of yacc.c  */
#line 44 "syntaxe.y"
    {identifTest((yyvsp[(3) - (3)].var),tokens,vars);;}
    break;
